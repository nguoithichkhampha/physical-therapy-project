...
public class HandController : MonoBehaviour {
  ...
  // Recording parameters.
  /** Set true to enable recording. */
  public bool enableRecordFile = false;
  ...
  /** Emotiv Engine Controller. */
  private EmoEngineController engine_contrller_;
  ...
  */
  ...
  void Update() {
	...
	engine_contrller_.ProcessEvent ();
  }
  ...
  */
  ...
  protected void UpdateRecorder() {
	...
	{
		current_index_action = menu.value;
			Debug.LogWarning ("current action " + current_index_action);
	}
